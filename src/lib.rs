...
compile_error!("The `debug` feature requires Rust 1.79 or later due to the `path_facts` dependency. Please upgrade your Rust version or remove the `debug` feature.");
